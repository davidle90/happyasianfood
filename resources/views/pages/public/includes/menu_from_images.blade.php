...
<div id="main-menu" class="mb-5">
    ...
    <img class="mb-2 border-brand" src="{{ asset('images/menu/haf_menu_4.jpg') }}" alt="menu_4">
    <img class="mb-2 border-brand" src="{{ asset('images/menu/haf_menu_5.jpg') }}" alt="menu_5">
    <img class="mb-2 border-brand" src="{{ asset('images/menu/haf_menu_6.jpg') }}" alt="menu_6">
</div>
...
<div id="take-away-menu" class="mb-5 hidden">
    ...
    <img class="mb-2 border-brand" src="{{ asset('images/menu/haf_ta_menu_5.jpg') }}" alt="ta_menu_5">
    <img class="mb-2 border-brand" src="{{ asset('images/menu/haf_ta_menu_6.jpg') }}" alt="ta_menu_6">
</div>
